...
%description
A bash prompt that displays information about the current git
repository. In particular the branch name, difference with remote
...
%changelog
* Sat Mar 31 2018 Koustubh Sinkar <ksinkar@gmail.com>
